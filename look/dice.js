...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-5c61534d');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-5c61534d');}
...
var brandEl=document.querySelector('.rl-brand-5c61534d');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
